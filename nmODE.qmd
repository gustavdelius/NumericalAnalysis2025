...
This section is optional. If you feel pressed for time, then you can skip forward to @sec-rk4.
...
::: {#exr-5.50}
Consider the function `backwardEuler1d()` below. How do you define the function `G` inside the `for` loop and what starting value do you use for the `fsolve()` command?
