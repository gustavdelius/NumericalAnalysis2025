...
::: {#exr-3.90a}
 Explain how to define arithmeticoperations on dual numbers and how to use them to compute the derivative of a function with forward mode automatic differentiation.
:::
